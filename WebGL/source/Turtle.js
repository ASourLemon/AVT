...
Turtle.prototype.draw = function (){
	...
	mat4.scale(mvMatrix, mvMatrix, [1.0*0.8, 1.0*0.8, 0.3*0.8]);
	drawSphere();
	mvPopMatrix();
	...
	mat4.scale(mvMatrix, mvMatrix, [1.2*0.9, 0.2*0.9, 0.1*0.9]);
	drawSphere();
	mvPopMatrix();
	...
	mvPushMatrix();	
	if(this.speed[0] < 0){
		mat4.translate(mvMatrix, mvMatrix, [-0.6, 0.0, 0.0]);	
	}else if(this.speed[0] > 0){
		mat4.translate(mvMatrix, mvMatrix, [0.6, 0.0, 0.0]);
	}
	mat4.scale(mvMatrix, mvMatrix, [1.0*0.3, 1.4*0.3, 0.4*0.3]);
	drawSphere();
	mvPopMatrix();
